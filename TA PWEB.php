...
<body>
	<div class="header" style="background-color: black;">
		<right><img src="logo.jpg" width="300px"></right>
		<h1 style="font-family: serif; color: white;">Assalamualaikum Wr Wb</h1>
		<p style="font-size: 27px; color: white;">M Nazhmi W H</p>
		<p style="font-size: 18px; color: white;">2100018016</p>
		<p style="font-size: 18px; color: white;">TUGAS AKHIR</p>
		<p style="font-size: 18px; color: white;">PEMROGRAMAN WEB</p>
	</div>

	<div class="rightcolumn" style="background-color: lightgrey" >
	        ...
	        ?>	    
	        <br>
	<table border="10" cellspacing="10" align="center" cellpadding="5">
		<tr bgcolor="orange">
    ...
    ?>
    <br><br>
    <center><img name="coolfan" src="spongebob.gif" width="200" height="200"></center>
            
			</div>
		</div>

	<div class="row" style="background-color: lightgrey">
		<div class="centercolumn" style="background-color: lightgrey">
			<div class="card" style="background-color: #fffbe7">
				...
				<h2 align="center" style="font-family: times new roman">TUGAS AKHIR PEMROGRAMAN WEB</h2><br><br>
				    ...
				    <tr>
					    <td>Moto Hidup</td>
					    <td><textarea name="moto" id="moto"></textarea></td>
				    </tr>
				    <tr>
					<td>Prodi</td>
		...
		<div align="center"><a href="lihat.php"><b>Lihat Data Diri<b></a></div>
			...
			<div class="card" style="background-color: orange;">
				<h1 style="font-family: Times New roman"> <center>Quote Of The Day</center></h1>
				
				<div class="card" style="background-color: lightgrey;">
		    		<h2 style="font-family: Arial">" Penghargaan paling tinggi bagi seorang pekerja keras bukanlah apa yang dia peroleh dari pekerjaan itu, tapi seberapa berkembang ia dengan kerja kerasnya itu."</h2>
		    		<p><h3>-John Ruskin-</h3></p>
	       		</div>
			</div>
		</div>
		...
		<h1><center>KALKULATOR</center></h1>
			<table border="10" cellspacing="10" align="center" cellpadding="15" style="background-color: red">
                <tr>
                    <td colspan="3" id="inputLabel">0</td>
                </tr>
